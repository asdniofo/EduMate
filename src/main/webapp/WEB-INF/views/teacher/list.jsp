            ...
            <div class="pagination-wrapper">
                <div class="pagination">
                	<c:if test="${startNavi ne 1 }">
					    <a href="/teacher/question/list?page=${startNavi - 1 }&filter=${filter}" class="page-button">?ù¥?†Ñ</a>
					</c:if>
					...
					<c:if test="${endNavi ne maxPage }">
					    <a href="/teacher/question/list?page=${endNavi + 1 }&filter=${filter}" class="page-button">?ã§?ùå</a>
					</c:if>
                </div>
            </div>
