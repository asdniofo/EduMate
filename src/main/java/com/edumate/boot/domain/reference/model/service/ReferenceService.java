...
public interface ReferenceService {
	 ...
	 * @param boardCountPerPage 페이지당 자료 개수
	 * @return 자료 목록
	 */
	List<Reference> selectList(int currentPage, int boardCountPerPage);
	...
	/**
	 * 자료 검색 (조건검색 + 페이징)
	 * @param searchMap 검색 조건 (searchCondition, searchKeyword, currentPage, boardLimit)
	 * @return 검색된 자료 목록
	 */
